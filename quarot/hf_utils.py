...
def quarot_model_config(
    model_name_or_path: str, model_path:str, dtype: torch.dtype, groupsize: int | None = None, offset: bool = False
):
    lm_configs = {
    ...
    model_config = lm_configs[model_name_or_path].from_pretrained(model_path, dtype=dtype, use_cache=False, token = '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')
